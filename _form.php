...
<style>
    /* css ini tidak menampilkan form  */
    .step {
        display: none;
    }

    /* css ini memblok tampilan tertentu  */
    .step.active {
        display: block;
    }
</style>
                        ...
                        <td>
                            <div class="form-group kv-fieldset-inline">
                                <div class="col-sm-12" style="padding:0;">
                                    <?=
                                    $form->field($model, 'JenisAnggota_id', [])->widget(
                                        Select2::classname(),
                                        [
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group kv-fieldset-inline">
                                ...
                                <div class="col-sm-6">
                                    <?=
                                    $form->field($model, 'TglLahir', [])->widget(MaskedDatePicker::classname(), [
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group kv-fieldset-inline">
                                <div class="col-sm-12" style="padding:0;">
                                    <?=
                                    $form->field($model, 'Sex_id', [])->widget(
                                        Select2::classname(),
                                        [
                                            'data' => ArrayHelper::map(JenisKelamin::find()->all(), 'ID', 'Name'),
                                            'size' => Select2::SMALL,
                            ...
                            <button type="button" class="btn btn-success col-sm-1" onclick="nextStep(2)">Next</button>
...
<div class="step" id="step2">
    <div class="member-form" style="padding:1em;display:block;position:relative;top:-30px;">
        <div class="col-md-12">
            <tr>
                <td class="pull-right">
                    <p><span class="label label-info required"><?= Yii::t('app', 'Alamat tinggal sesuai identitas') ?>*</span></p>
                <td>
                    <div class="form-group kv-fieldset-inline">
                        <div class="col-sm-12" style="padding:0;">
                            <?=
        ...
        <?php } ?>
        <button type="button" class="btn btn-default col-sm-1 " onclick="nextStep(1)">Back</button>
        <button type="button" class="btn btn-success col-sm-1" style="margin-left: 7px;" onclick="nextStep(3)">Next</button>
...
?>
    ...
    <div class="step" id="step3">
        <div class="col-md-12">
            <tr>
                <td class="pull-right">
                    <?= Yii::t('app', 'Pendidikan') ?><span class="require">*</span>
                </td>
                <td>
                    <div class="form-group kv-fieldset-inline">
                        <div class="col-sm-12" style="padding:0;">
                            ...
                            $form->field($model, 'EducationLevel_id')->widget(
                                ...
                                [
                                    ...
                                    'size' => Select2::SMALL,
                                    'options' => [
                                        'placeholder' => Yii::t('app', 'Pilih Pendidikan'),
                                    ],
                                    'pluginOptions' => [
                                        'allowClear' => true,
                                        //'width'=> '150px',
            ...
            <tr>
                ...
                <td>
                    <div class="form-group kv-fieldset-inline">
                        <div class="col-sm-12" style="padding:0;">
                            <?=
                            $form->field($model, 'Job_id')->widget(
                                Select2::classname(),
                                [
            ...
            <tr>
                ...
                <td>
                    <div class="form-group kv-fieldset-inline">
                        <div class="col-sm-12" style="padding:0;">
                            <?=
                            $form->field($model, 'Agama_id')->widget(
                                Select2::classname(),
                                [
                ...
                <td>
                    <div class="form-group kv-fieldset-inline">
                        <div class="col-sm-12" style="padding:0;">
                            ...
                            <?=
                            $form->field($model, 'MaritalStatus_id', [])->widget(
                                Select2::classname(),
                                [
            ...
            <tr>
                ...
                <td>
                    <div class="form-group kv-fieldset-inline">
                        <div class="col-sm-12" style="padding:0;">
                            <?=
                            $form->field($model, 'UnitKerja_id')->widget(
                                Select2::classname(),
                                [
            ...
            <tr>
                ...
                <td>
                    <div class="form-group kv-fieldset-inline">
                        <div class="col-sm-12" style="padding:0;">
                            <?=
                            $form->field($model, 'Fakultas_id')->widget(
                                Select2::classname(),
                                [
            ...
            <tr>
                ...
                <td>
                    <div class="form-group kv-fieldset-inline">
                        <div class="col-sm-12" style="padding:0;">
                            <?=
                            $form->field($model, 'Jurusan_id')->widget(
                                DepDrop::classname(),
                                [
            ...
            <tr>
                ...
                <td>
                    <div class="form-group kv-fieldset-inline">
                        <div class="col-sm-12" style="padding:0;">
                            <?=
                            $form->field($model, 'Kelas_id')->widget(
                                Select2::classname(),
                                [
        ...
        <tr>
            <td>
                <div class="checkbox"><label>
                        <input type="checkbox" name="disclamer" id="disclamer">
                        <?= Yii::t('app', 'disclamer') ?></label>
                </div>
            </td>

            <div class="text-left">
                <button type="button" class="btn btn-default col-sm-1" style="margin-right: 7px;" onclick="nextStep(2)">Back</button>
                <div id="button" style="display: none;">
                    <?php
                    echo '&nbsp;' . Html::submitButton($model->isNewRecord ? Yii::t('app', 'Create') : Yii::t('app', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary', 'col-sm-1']);
                    ?>
                </div>
            </div>
        </tr>
    ...
    $this->registerJs("
                                    ...
                                    $(document).ready(function () {
                                        $('#disclamer').on('change', function () {
                                            if ($(this).is(':checked')) {
                                                $('#bu tton').removeAttr('hidden');
                                            } else {
